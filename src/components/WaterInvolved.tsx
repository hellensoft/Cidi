						...
						<div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
							...
							<div className="pt-12 sm:pt-16 lg:pt-20">
								...
								<ul className="list-disc ml-6 mt-6 space-y-6 text-gray-500">
									...
									<li className="text-sm md:text-base text-justify">
									    To provide technical assistance to WASH governance Systems, Structures   and WASH management bodies
									</li>
									
									<li className="text-sm md:text-base text-justify">
									To prevent the spread of diseases due to poor sanitation, unhygienic living conditions and unsafe drinking water. 
									</li>
									<li className="text-sm md:text-base text-justify">
							...
							>
								...
								<div className="pt-12 sm:pt-16 lg:pt-20">
									...
									<ul className="list-disc ml-6 mt-6 space-y-3 text-gray-500">
										<li className="text-sm md:text-base text-justify">
										Building entrepreneurship in the management of solid waste and liquid waste in Slum areas. 
										</li>
										<li className="text-sm md:text-base text-justify">
										Demand creation for WASH services and Hygiene promotion. 
										</li>
										<li className="text-sm md:text-base text-justify">
										Designing and construction of WASH infrastructures and post construction support services.
										</li>
										...
										<li className="text-sm md:text-base text-justify">
										Design and implementation of sustainable waste management modal, Waste Treatment, recycling, reuse or disposal. 
										</li>
									</ul>
								</div>
							</div>
