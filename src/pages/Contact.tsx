...
const Contact: FC<IContact> = () => {
	return (
		<div>
			...
			<div className="grid grid-cols-2 place-content-center my-24">
				<div className="w-full h-auto aspect-[9/7] bg-sectionGray">
					<iframe
				...
				<div className="pr-[calc(((100vw-1222px)/2))]">
					<div className="pr-4 pl-12 flex flex-col justify-center h-full">
							...
							<Form className="space-y-6">
								<div className="grid grid-cols-2 gap-8">
									<Field
										...
										name="firstName"
										id="firstName"
										className="block w-full border-0 pb-2 border-b border-textBlue text-xl focus:border-greenPrimary focus:ring-0"
