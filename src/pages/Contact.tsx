	...
	return (
		<div>
			...
			<div className="grid lg:grid-cols-2 place-content-center my-24">
				<div className="row-start-2 lg:row-start-1 w-screen lg:w-full h-auto aspect-[9/7] sm:aspect-[9/5] lg:aspect-[9/7] bg-sectionGray" data-aos="fade-up" data-aos-duration="1000">
					<iframe
				...
				<div className="px-4 mb-12 lg:mb-0 lg:pr-[calc(((100vw-1222px)/2))]" data-aos="fade-up" data-aos-duration="1000">
					<div className="lg:pr-4 lg:pl-12 flex flex-col justify-center h-full">
						...
						<h1 className="text-3xl text-darkBlue font-semibold mb-8  mt-2">
							Have Questions?
							<br /> Get in Touch
						</h1>
						<Formik
